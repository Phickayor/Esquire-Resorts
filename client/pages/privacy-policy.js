        ...
        <div className="space-y-8">
          ...
          <div className="space-y-5 ">
            ...
            <ul className="space-y-4 w-11/12 text-md lg:[&>*]:leading-[3rem] [&>*]:leading-[2rem]">
              <li>
                ...
                name and email address when you submit feedback or complaints
                through our Website.
              </li>
              <li>
                b.<b> Usage Information:</b> We may collect non-personal
                information about your interactions with the Website, such as
                your IP address, browser type, referring website, pages visited,
                and the date and time of each visit. This information is
          ...
          <div className="space-y-5">
            ...
            <ul className="space-y-4 w-11/12 text-md leading-6">
              <li>
                a. We use the personal information you provide to respond to
                your feedback or complaints, communicate with you, and improve
                our services.
              </li>
              <li>
                b. We may also use your personal information to send you
                updates, newsletters, or promotional materials if you have opted
                to receive such communications.
              </li>
              <li>
                c. We do not sell, rent, or lease your personal information to
                third parties unless we have obtained your explicit consent or
          ...
          <div className="space-y-5">
            ...
            <ul className="space-y-4 w-11/12 text-md leading-6">
              <li>
                ...
                Website and providing services to you. These service providers
              ...
              <li>
                ...
                regulation, or legal process, or if we believe it is necessary
          ...
          <div className="space-y-5">
            ...
            <ul className="space-y-4 w-11/12 text-md leading-6">
              <li>
                ...
                Policy periodically to stay informed about our privacy
                practices.
              </li>
            </ul>
          </div>
          <div>
            <h3 className="text-xl lg:text-2xl font-medium">8. Contact Us</h3>
            <p className="text-lg">
          ...
          <p className="text-lg">
            ...
            By using the Website, you signify your agreement to this Privacy
            Policy.
          </p>
          <h3 className="text-xl lg:text-2xl font-medium">
