...
function Login() {
    ...
    return (
        <>
            ...
            <div className={`bg-black relative h-screen text-white ${poppins.className}`}>
                <Image
                ...
                <div className=' space-y-10 p-5 w-full md:w-[500px] absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2' >
                    <h1 className='text-4xl inline-block  font-semibold border-b-4 py-1 lg:py-3 border-purple-500'>Login</h1>
                    <form
                        ...
                        <button type='submit'
                            className='border-2 mx-auto border-purple-500 w-10/12 self-center hover:border-none duration-500 ease-in-out scale hover:bg-purple-500 font-bold py-2'>{load} Sign In</button>
                    </form>
