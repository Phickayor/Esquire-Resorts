    ...
    return (
        <div className={poppins.className}>
            <NavBar
                ...
                fourthlink="/contact"
                firstNav={"Home"} />
            <div className='mx-auto w-11/12 lg:w-10/12 my-10 '>
                <h3 className='text-3xl font-bold my-10'>Terms Of Service</h3>
                <div className='space-y-8'>
                    <h3 className='text-2xl font-semibold mt-5'>Effective Date: 4th June 2023</h3>
                    <p className='text-lg'>
                        These Terms of Service <q>Terms</q> govern your use of Esquire Resorts website (<q>Website</q>)
                    ...
                    <div className='space-y-5'>
                        ...
                        <p className='text-lg'>The content on the Website is provided for informational purposes only.
                            ...
                            other professional advice. Esquire Resorts does not accept any responsibility for any decisions made
                    ...
                    <div className='space-y-5'>
                        ...
                        <p className='text-lg'>The Website provides a platform for users to provide
                            feedback or submit complaints to Esquire Resorts.
                        ...
                        <ul className='space-y-4 w-11/12 text-md leading-6'>
                            ...
                            <li>
                                b.<b> Consent to Communication:</b> By submitting feedback or a complaint, you consent to Esquire Resorts
                                contacting you via the email address provided for the purpose of resolving your feedback or complaint.
                            </li>
                            <li>
                                c.<b> Confidentiality:</b> While Esquire Resorts will take reasonable measures to protect the information
                                you provide, you acknowledge that the transmission of information over the internet is not completely secure.
                                Therefore, Esquire Resorts cannot guarantee the absolute confidentiality of your information.
                            </li>
                            <li>
                                d.<b> Non-Confidentiality of Feedback:</b> You acknowledge and agree that any feedback or suggestions
                                you provide to Esquire Resorts through the Website may be used by Esquire Resorts without any obligation to
                    ...
                    <div className='space-y-5'>
                        ...
                        <p className='text-lg'>The content, design, and layout of the Website are protected by intellectual
                            ...
                            or create derivative works of any materials on the Website without prior written consent from Esquire Resorts.
                        </p>
                    </div>
                    <div className='space-y-5'>
                        <h3 className='text-2xl font-semibold mt-5'>4. Disclaimer of Warranty</h3>
                        <p className='text-lg'>The Website and its content are provided on an <q>as-is</q> basis.
                            Esquire Resorts makes no warranties, expressed or implied, regarding the accuracy, reliability,
                    ...
                    <div className='space-y-5'>
                        ...
                        <p className='text-lg'>To the fullest extent permitted by applicable law,
                            Esquire Resorts shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including but not limited to damages for loss of profits, goodwill,
                    ...
                    <div className='space-y-5'>
                        ...
                        <p className='text-lg'>
                            Esquire Resorts reserves the right to modify or update these Terms at any time without prior notice.
                    ...
                    <p className='text-lg'>
                        ...
                        <a href="mailto:esquireresorts@gmail.com" className='text-blue-500'> esquireresorts@gmail.com .</a>
                    </p>
                    <p className='text-lg'>
