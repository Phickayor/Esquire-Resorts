    ...
    <>
      ...
      <div className="[&>*]:py-12 px-5 md:px-10 lg:px-20 xl:px-36 ">
        <div className="space-y-8 ">
          ...
          <p className="text-lg">
            These Terms of Service <q>Terms</q> govern your use of Esquire
            Resorts website (<q>Website</q>) and the services provided through
          ...
          <div className="space-y-5">
            ...
            <p className="text-lg">
              ...
              only. It does not constitute professional advice, including but
              not limited to legal, financial, or any other professional advice.
              Esquire Resorts does not accept any responsibility for any
              decisions made based on the information provided on the Website.
            </p>
          </div>
          <div className="space-y-5">
            <h3 className="text-xl lg:text-2xl font-medium">
            ...
            <ul className="space-y-4 w-11/12 text-md lg:[&>*]:leading-[3rem] [&>*]:leading-[2rem]">
              <li>
                a.<b> Accuracy of Information:</b> You represent and warrant
                that the information you provide, including your name and email
              ...
              <li>
                ...
                email address provided for the purpose of resolving your
                feedback or complaint.
              </li>
              <li>
                c.<b> Confidentiality:</b> While Esquire Resorts will take
                reasonable measures to protect the information you provide, you
                acknowledge that the transmission of information over the
                internet is not completely secure. Therefore, Esquire Resorts
                cannot guarantee the absolute confidentiality of your
                information.
              </li>
              <li>
                d.<b> Non-Confidentiality of Feedback:</b> You acknowledge and
                agree that any feedback or suggestions you provide to Esquire
                Resorts through the Website may be used by Esquire Resorts
                without any obligation to compensate you or maintain the
                confidentiality of such feedback.
              </li>
            </ul>
          </div>
          <div className="space-y-5">
            <h3 className="text-xl lg:text-2xl font-medium mt-5">
            ...
            <p className="text-lg">
              ...
              derivative works of any materials on the Website without prior
              written consent from Esquire Resorts.
            </p>
          </div>
          <div className="space-y-5">
            <h3 className="text-xl lg:text-2xl font-medium mt-5">
            ...
            <p className="text-lg">
              ...
              Esquire Resorts makes no warranties, expressed or implied,
              regarding the accuracy, reliability, or availability of the
              Website. You acknowledge that your use of the Website is at your
              own risk.
            </p>
          </div>
          <div className="space-y-5">
          ...
          <div className="space-y-5">
            <h3 className="text-xl lg:text-2xl font-medium">8. Severability</h3>
            <p className="text-lg">
          ...
          <p className="text-lg">
            ...
            Website. By using the Website, you signify your agreement to these
            Terms.
          </p>
        </div>
      </div>
